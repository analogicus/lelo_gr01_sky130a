...
N 210 -20 240 -20 {lab=#net1}
N 90 -170 280 -170 {lab=VDD_1V8}
N 280 -50 280 -20 {lab=VDD_1V8}
N 90 -50 90 -20 {lab=VDD_1V8}
N -60 -50 -60 -20 {lab=VDD_1V8}
N -60 100 50 100 {lab=#net2}
N 90 100 90 130 {lab=#net3}
N 280 10 280 60 {lab=IBP}
N -340 -50 -340 -30 {lab=#net4}
N -340 -170 -60 -170 {lab=VDD_1V8}
N -340 50 -340 70 {lab=#net5}
N -340 60 -270 60 {lab=#net5}
N -270 60 -270 100 {lab=#net5}
N -300 100 -240 100 {lab=#net5}
...
N 280 -170 280 -50 {lab=VDD_1V8}
N 90 170 90 250 {lab=#net3}
...
C {JNW_TR_SKY130A/JNWTR_RPPO8.sym} 90 260 1 0 {name=x3 }
...
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_4C5F0.sym} 240 -20 0 0 {name=x7 }
