...
N 740 -620 740 -530 {lab=#net4}
N 740 -680 740 -620 {lab=#net4}
N 740 -680 760 -680 {lab=#net4}
N 760 -680 760 -660 {lab=#net4}
N 760 -490 760 -460 {lab=#net5}
N 580 -430 650 -430 {lab=#net2}
N 540 -460 540 -430 {lab=#net4}
N 540 -680 740 -680 {lab=#net4}
N 950 -410 950 -290 {lab=IBN}
N 760 -430 780 -430 {lab=VDD_1V8}
N 650 -430 720 -430 {lab=#net2}
N 540 -380 600 -380 {lab=#net2}
N 540 -610 540 -580 {lab=#net4}
N 540 -680 540 -610 {lab=#net4}
N 540 -550 540 -460 {lab=#net4}
...
N 660 -730 660 -680 {lab=#net4}
N 650 50 660 50 {lab=#net6}
...
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} 630 -180 0 0 {name=x8}
...
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_2C5F0.sym} 620 -760 0 0 {name=x9}
