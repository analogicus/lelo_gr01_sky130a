...
N 760 -580 760 -570 {lab=#net2}
N 740 -680 760 -680 {lab=#net2}
N 760 -680 760 -660 {lab=#net2}
N 760 -490 760 -460 {lab=#net3}
N 580 -430 650 -430 {lab=#net4}
N 540 -680 740 -680 {lab=#net2}
N 650 -430 720 -430 {lab=#net4}
N 540 -380 600 -380 {lab=#net4}
N 540 -610 540 -580 {lab=#net2}
N 540 -680 540 -610 {lab=#net2}
N 540 -550 540 -460 {lab=#net2}
N 600 -380 630 -380 {lab=#net4}
N 630 -380 630 -370 {lab=#net4}
N 630 -430 630 -380 {lab=#net4}
N 630 -310 630 -240 {lab=#net1}
N 600 -180 630 -180 {lab=PWRUP_N_1V8}
N 540 -580 540 -550 {lab=#net2}
N 660 -730 660 -680 {lab=#net2}
N 590 -380 590 -340 {lab=#net4}
...
N 540 -460 540 -430 {lab=#net2}
N 760 -460 760 -430 {lab=#net3}
N 540 -400 540 -380 {lab=#net4}
N 540 -280 540 -270 {lab=#net4}
N 540 -380 540 -340 {lab=#net4}
N 760 -110 760 -100 {lab=VSS}
N 950 -320 950 -290 {lab=IBN}
N 760 -210 760 -110 {lab=VSS}
N 540 -340 540 -280 {lab=#net4}
N 950 -410 950 -320 {lab=IBN}
N 760 -660 760 -580 {lab=#net2}
N 670 -150 670 -100 {lab=VSS}
N 540 -110 540 -100 {lab=VSS}
N 540 -210 540 -190 {lab=VSS}
N 540 -190 540 -110 {lab=VSS}
N 630 -340 650 -340 {lab=VSS}
...
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} 910 -240 0 0 {name=x9[2:0]}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} 720 -240 0 0 {name=x5}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} 580 -240 0 1 {name=x2}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} 630 -180 0 0 {name=x1}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} 590 -340 0 0 {name=x7}
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_2C5F0.sym} 580 -430 0 1 {name=x8}
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_2C5F0.sym} 720 -430 0 0 {name=x3}
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_2C5F0.sym} 620 -760 0 0 {name=x4}
C {devices/lab_pin.sym} 650 -340 0 1 {name=p8 sig_type=std_logic lab=VSS}
