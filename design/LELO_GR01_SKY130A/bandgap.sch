...
N 250 -70 440 -70 {lab=#net1}
N 250 690 450 690 {lab=VSS}
N 450 -70 450 -30 {lab=#net1}
N 440 -70 450 -70 {lab=#net1}
N 90 100 90 130 {lab=VIN}
N -90 690 -50 690 {lab=VSS}
N -30 660 -0 660 {lab=VSS}
N 0 660 50 660 {lab=VSS}
N 450 420 450 430 {lab=#net8}
N 430 380 430 470 {lab=VSS}
N 450 600 450 630 {lab=#net9}
N 450 510 450 520 {lab=#net10}
N 430 470 430 560 {lab=VSS}
N 450 60 450 70 {lab=VREF}
N 390 520 450 520 {lab=#net10}
N 390 600 450 600 {lab=#net9}
N 360 560 370 560 {lab=VSS}
N 450 -70 710 -70 {lab=#net1}
N 710 -70 710 -20 {lab=#net1}
N 710 -20 710 10 {lab=#net1}
N 640 10 670 10 {lab=VOUT}
N 710 40 710 60 {lab=IBP}
N 710 60 760 60 {lab=IBP}
...
C {devices/opin.sym} 760 60 0 0 {name=p23 lab=IBP}
