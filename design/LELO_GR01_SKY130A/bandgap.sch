...
N -320 140 -290 140 {lab=PWRUP_1V8}
N 290 520 390 520 {lab=NET9}
N 290 600 390 600 {lab=#net8}
N 260 560 270 560 {lab=VSS}
...
C {JNW_TR_SKY130A/JNWTR_RPPO4.sym} 390 520 1 0 {name=x14}
