...
N -340 140 -290 140 {lab=PWRUP_1V8}
N -400 530 -400 560 {lab=VSS}
N -370 530 -340 530 {lab=VIN}
N -460 530 -440 530 {lab=VIP}
N -440 530 -430 530 {lab=VIP}
N -400 460 -400 490 {lab=PWRUP_1V8}
...
C {devices/ipin.sym} -70 210 0 0 {name=p15 lab=PWRUP_1V8}
...
C {LELO_GR01_SKY130A/diffamp_1_CM.sym} 0 120 3 0 {name=x1}
...
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_2C5F0.sym} 670 10 0 0 {name=xiptat}
...
C {devices/ipin.sym} -70 170 0 0 {name=p10 lab=PWRUP_N_1V8}
C {devices/lab_pin.sym} -340 140 0 0 {name=p12 sig_type=std_logic lab=PWRUP_1V8}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_2C5F0.sym} -400 490 1 0 {name=x1[3:0]}
C {devices/lab_wire.sym} -400 560 3 0 {name=p13 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -460 530 0 0 {name=p22 sig_type=std_logic lab=VIP}
C {devices/lab_pin.sym} -340 530 0 1 {name=p27 sig_type=std_logic lab=VIN}
C {devices/lab_pin.sym} -400 460 0 0 {name=p28 sig_type=std_logic lab=PWRUP_1V8}
