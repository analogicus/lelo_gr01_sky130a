...
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 540 -570 0 1 {name=x2}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 340 -570 0 0 {name=x3}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 340 -430 0 0 {name=x4[3:0]}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 200 -430 0 1 {name=x6 }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 540 -430 0 1 {name=x7[3:0]}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 680 -430 0 0 {name=x8 }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 200 -830 0 1 {name=x11}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 680 -830 0 0 {name=x10}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 590 -390 0 0 {name=x1 }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 240 -390 0 0 {name=x9 }
C {devices/ipin.sym} 80 -370 0 0 {name=p8 lab=PWRUP_N_1V8}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 400 -650 0 0 {name=x12}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 600 -780 0 0 {name=x13}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 430 -880 0 0 {name=x14}
