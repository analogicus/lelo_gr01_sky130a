...
N 790 -280 940 -280 {lab=#net3}
N 940 -280 940 -230 {lab=#net3}
N 790 -400 790 -240 {lab=#net3}
N 600 -520 790 -520 {lab=VDD_1V8}
N 790 -520 790 -460 {lab=VDD_1V8}
N 790 -460 790 -430 {lab=VDD_1V8}
N 720 -430 750 -430 {lab=VOUT_BG}
N 1090 -310 1170 -310 {lab=#net3}
N 1090 -350 1170 -350 {lab=VREF_BG}
N 790 -310 1090 -310 {lab=#net3}
...
C {devices/ipin.sym} 350 -230 0 0 {name=p9 lab=IB}
C {devices/lab_wire.sym} 1090 -330 0 0 {name=p4 sig_type=std_logic lab=IB}
...
C {devices/lab_wire.sym} 600 -520 0 0 {name=p12 sig_type=std_logic lab=VDD_1V8}
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_2C5F0.sym} 750 -430 0 0 {name=x6}
...
C {devices/ipin.sym} 350 -180 0 0 {name=p14 lab=VOUT_BG}
C {devices/lab_wire.sym} 600 -430 0 0 {name=p15 sig_type=std_logic lab=VOUT_BG}
