...
N 1390 -310 1390 -270 {lab=PWRUP_N_1V8}
...
C {devices/lab_pin.sym} 1390 -270 3 0 {name=p18 sig_type=std_logic lab=PWRUP_N_1V8}
C {JNW_TR_SKY130A/JNWTR_NRX1_CV.sym} 1390 -310 0 0 {name=x2 }
