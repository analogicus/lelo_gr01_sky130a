...
C {LELO_GR01_SKY130A/diffamp_1_reversed.sym} 1320 -330 0 0 {name=x1}
...
C {devices/ipin.sym} 1230 -400 1 0 {name=p9 lab=PWRUP_1V8}
C {devices/ipin.sym} 1270 -400 1 0 {name=p12 lab=PWRUP_N_1V8}
