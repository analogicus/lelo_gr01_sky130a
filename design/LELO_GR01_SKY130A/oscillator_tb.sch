...
N 370 -110 400 -110 {lab=PWRUP_1V8}
...
C {devices/ipin.sym} -160 -130 0 0 {name=p5 lab=PWRUP_1V8}
C {devices/lab_pin.sym} 370 -110 0 0 {name=p6 sig_type=std_logic lab=PWRUP_1V8}
C {devices/lab_pin.sym} 1110 -210 0 1 {name=p8 sig_type=std_logic lab=PWRUP_N_1V8}
C {devices/lab_pin.sym} 550 -190 0 0 {name=p10 sig_type=std_logic lab=PWRUP_N_1V8}
C {devices/lab_pin.sym} 1070 -210 0 0 {name=p12 sig_type=std_logic lab=PWRUP_1V8}
